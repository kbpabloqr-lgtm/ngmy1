...
class _GlobalNotificationsScreenState extends State<GlobalNotificationsScreen> {
  ...
  Future<void> _loadNotifications() async {
    ...
    final notificationsJson = prefs.getString('${username}_global_notifications');
    ...
    if (notificationsJson != null) {
      ...
      if (filteredNotifications.length != decoded.length) {
        await prefs.setString('${username}_global_notifications', jsonEncode(filteredNotifications));
      }
  ...
  Future<void> _markAsRead(int index) async {
    ...
    final prefs = await SharedPreferences.getInstance();
    final username = prefs.getString('global_user_name') ?? 'NGMY User';
    await prefs.setString('${username}_global_notifications', jsonEncode(_notifications));
  }
      ...
      body: _notifications.isEmpty
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Dismissible(
                  key: Key('global_notification_${notification['id'] ?? index}'),
